...
Future<void> addTicket({ required Ticket ticket ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kAddTicketConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> updateTicket({ required Ticket ticket ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kUpdateTicketConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = _platform.api2wire_StringList(tagsFilter);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_query_ticket(port_, arg0, arg1, arg2, arg3),
        ...
        FlutterRustBridgeTaskConstMeta get kQueryTicketConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "query_ticket",
            argNames: ["orderTypeFilter", "timeFilter", "courserFilter", "tagsFilter"],
        );
        
Future<List<Ticket>> getTickets({ required List<String> ticketIds ,dynamic hint }) {
            var arg0 = _platform.api2wire_StringList(ticketIds);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_tickets(port_, arg0),
            parseSuccessData: _wire2api_list_ticket,
            parseErrorData: null,
            
        constMeta: kGetTicketsConstMeta,
        argValues: [ticketIds],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kGetTicketsConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "get_tickets",
            argNames: ["ticketIds"],
        );
        
Future<List<OrderItem>> getOrderItems({ required List<String> orderItemIds ,dynamic hint }) {
            var arg0 = _platform.api2wire_StringList(orderItemIds);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_order_items(port_, arg0),
            parseSuccessData: _wire2api_list_order_item,
            parseErrorData: null,
            
        constMeta: kGetOrderItemsConstMeta,
        argValues: [orderItemIds],
        hint: hint,
        
        ));}


        FlutterRustBridgeTaskConstMeta get kGetOrderItemsConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "get_order_items",
            argNames: ["orderItemIds"],
        );
        
Future<void> updateOrderItem({ required OrderItem orderItem ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_order_item(orderItem);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_update_order_item(port_, arg0),
            parseSuccessData: _wire2api_unit,
            parseErrorData: null,
            
        constMeta: kUpdateOrderItemConstMeta,
        argValues: [orderItem],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kUpdateOrderItemConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Stream<CallbackChanged> createCallbackStream({ dynamic hint }) {
            ...
            callFfi: (port_) => _platform.inner.wire_create_callback_stream(port_),
            parseSuccessData: _wire2api_callback_changed,
            parseErrorData: null,
            
        constMeta: kCreateCallbackStreamConstMeta,
        argValues: [],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kCreateCallbackStreamConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "create_callback_stream",
            argNames: [],
        );
...
AdditionFee _wire2api_addition_fee(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return AdditionFee(name: _wire2api_String(arr[0]),
...
CallbackChanged _wire2api_callback_changed(dynamic raw) {
            switch (raw[0]) {
                case 0: return CallbackChanged_UpDateTickets(tickets: _wire2api_list_ticket(raw[1]),);
case 1: return CallbackChanged_UpdateOrderItems(orderItems: _wire2api_list_order_item(raw[1]),);
case 2: return CallbackChanged_NewTickets(tickets: _wire2api_list_ticket(raw[1]),);
...
Component _wire2api_component(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Component(name: _wire2api_String(arr[0]),
...
Costs _wire2api_costs(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Costs(subtotal: _wire2api_String(arr[0]),
...
Courser _wire2api_courser(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Courser(name: _wire2api_String(arr[0]),
...
CreatedEntity _wire2api_created_entity(dynamic raw) {
            switch (raw[0]) {
                case 0: return CreatedEntity_Staff(_wire2api_box_autoadd_staff(raw[1]),);
case 1: return CreatedEntity_OrderOnlineParty(_wire2api_box_autoadd_order_online_party(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
OrderItem _wire2api_order_item(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return OrderItem(name: _wire2api_String(arr[0]),
...
OrderItemStatus _wire2api_order_item_status(dynamic raw) {
            switch (raw[0]) {
                case 0: return OrderItemStatus_Cooking();
case 1: return OrderItemStatus_Avoid(_wire2api_String(raw[1]),);
case 2: return OrderItemStatus_Pending();
case 3: return OrderItemStatus_Done();
                default: throw Exception("unreachable");
            }
        }
...
OrderOnlineParty _wire2api_order_online_party(dynamic raw) {
            switch (raw[0]) {
                case 0: return OrderOnlineParty_Uber();
case 1: return OrderOnlineParty_Grab();
case 2: return OrderOnlineParty_UberEat();
case 3: return OrderOnlineParty_DoorDash();
case 4: return OrderOnlineParty_SkipTheDisk();
case 5: return OrderOnlineParty_Other(name: _wire2api_String(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
OrderType _wire2api_order_type(dynamic raw) {
            switch (raw[0]) {
                case 0: return OrderType_Delivery(_wire2api_box_autoadd_order_type_info(raw[1]),);
case 1: return OrderType_ForHere(_wire2api_box_autoadd_order_type_info(raw[1]),);
case 2: return OrderType_Pickup(_wire2api_box_autoadd_order_type_info(raw[1]),);
case 3: return OrderType_DriveThrough(_wire2api_box_autoadd_order_type_info(raw[1]),);
case 4: return OrderType_Curbside(_wire2api_box_autoadd_order_type_info(raw[1]),);
case 5: return OrderType_Togo(_wire2api_box_autoadd_order_type_info(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
OrderTypeInfo _wire2api_order_type_info(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return OrderTypeInfo(name: _wire2api_String(arr[0]),
...
PromoCode _wire2api_promo_code(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return PromoCode(name: _wire2api_String(arr[0]),
amount: _wire2api_String(arr[1]),);
        }
...
RetryInfo _wire2api_retry_info(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return RetryInfo(notificationUrl: _wire2api_String(arr[0]),
...
SMSNotify _wire2api_sms_notify(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 3) throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
                return SMSNotify(name: _wire2api_String(arr[0]),
phone: _wire2api_String(arr[1]),
...
Staff _wire2api_staff(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Staff(name: _wire2api_String(arr[0]),
...
Ticket _wire2api_ticket(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 11) throw Exception('unexpected arr length: expect 11 but see ${arr.length}');
                return Ticket(orderType: _wire2api_order_type(arr[0]),
...
TicketStatus _wire2api_ticket_status(dynamic raw) {
            switch (raw[0]) {
                case 0: return TicketStatus_Cooking();
case 1: return TicketStatus_Avoid(_wire2api_String(raw[1]),);
case 2: return TicketStatus_Pending();
case 3: return TicketStatus_Done();
                default: throw Exception("unreachable");
            }
        }
...
@protected
                    ffi.Pointer<wire_FilterTime> api2wire_box_autoadd_filter_time(FilterTime raw) {
                        final ptr = inner.new_box_autoadd_filter_time_0();
                        _api_fill_to_wire_filter_time(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_OrderItem> api2wire_box_autoadd_order_item(OrderItem raw) {
                        final ptr = inner.new_box_autoadd_order_item_0();
                        _api_fill_to_wire_order_item(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_OrderOnlineParty> api2wire_box_autoadd_order_online_party(OrderOnlineParty raw) {
                        final ptr = inner.new_box_autoadd_order_online_party_0();
                        _api_fill_to_wire_order_online_party(raw, ptr.ref);
                        return ptr;
                    }
@protected
                    ffi.Pointer<wire_OrderTypeInfo> api2wire_box_autoadd_order_type_info(OrderTypeInfo raw) {
...
@protected
                    ffi.Pointer<wire_list_addition_fee> api2wire_list_addition_fee(List<AdditionFee> raw) {
...
@protected
                    ffi.Pointer<wire_list_component> api2wire_list_component(List<Component> raw) {
...
@protected
                    ffi.Pointer<wire_list_order_item> api2wire_list_order_item(List<OrderItem> raw) {
...
@protected
                    ffi.Pointer<wire_list_order_type> api2wire_list_order_type(List<OrderType> raw) {
...
@protected
                    ffi.Pointer<wire_list_promo_code> api2wire_list_promo_code(List<PromoCode> raw) {
...
@protected
                    ffi.Pointer<wire_RetryInfo> api2wire_opt_box_autoadd_retry_info(RetryInfo? raw) {
                        return raw == null ? ffi.nullptr : api2wire_box_autoadd_retry_info(raw);
                    }
@protected
                    ffi.Pointer<wire_SMSNotify> api2wire_opt_box_autoadd_sms_notify(SMSNotify? raw) {
...
void _api_fill_to_wire_addition_fee(AdditionFee apiObj, wire_AdditionFee wireObj) {
                wireObj.name = api2wire_String(apiObj.name);
wireObj.amount = api2wire_String(apiObj.amount);
            }

void _api_fill_to_wire_box_autoadd_costs(Costs apiObj, ffi.Pointer<wire_Costs> wireObj) {
                _api_fill_to_wire_costs(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_courser(Courser apiObj, ffi.Pointer<wire_Courser> wireObj) {
                _api_fill_to_wire_courser(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_filter_time(FilterTime apiObj, ffi.Pointer<wire_FilterTime> wireObj) {
                _api_fill_to_wire_filter_time(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_order_item(OrderItem apiObj, ffi.Pointer<wire_OrderItem> wireObj) {
                _api_fill_to_wire_order_item(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_order_online_party(OrderOnlineParty apiObj, ffi.Pointer<wire_OrderOnlineParty> wireObj) {
                _api_fill_to_wire_order_online_party(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_order_type_info(OrderTypeInfo apiObj, ffi.Pointer<wire_OrderTypeInfo> wireObj) {
                _api_fill_to_wire_order_type_info(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_retry_info(RetryInfo apiObj, ffi.Pointer<wire_RetryInfo> wireObj) {
                _api_fill_to_wire_retry_info(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_sms_notify(SMSNotify apiObj, ffi.Pointer<wire_SMSNotify> wireObj) {
                _api_fill_to_wire_sms_notify(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_staff(Staff apiObj, ffi.Pointer<wire_Staff> wireObj) {
                _api_fill_to_wire_staff(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_ticket(Ticket apiObj, ffi.Pointer<wire_Ticket> wireObj) {
...
void _api_fill_to_wire_created_entity(CreatedEntity apiObj, wire_CreatedEntity wireObj) {
...
void _api_fill_to_wire_filter_time(FilterTime apiObj, wire_FilterTime wireObj) {
...
void _api_fill_to_wire_opt_box_autoadd_costs(Costs? apiObj, ffi.Pointer<wire_Costs> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_costs(apiObj, wireObj);
            }

void _api_fill_to_wire_opt_box_autoadd_courser(Courser? apiObj, ffi.Pointer<wire_Courser> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_courser(apiObj, wireObj);
            }

void _api_fill_to_wire_opt_box_autoadd_retry_info(RetryInfo? apiObj, ffi.Pointer<wire_RetryInfo> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_retry_info(apiObj, wireObj);
            }

void _api_fill_to_wire_opt_box_autoadd_sms_notify(SMSNotify? apiObj, ffi.Pointer<wire_SMSNotify> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd_sms_notify(apiObj, wireObj);
            }
...
void _api_fill_to_wire_order_item_status(OrderItemStatus apiObj, wire_OrderItemStatus wireObj) {
                if (apiObj is OrderItemStatus_Cooking) { wireObj.tag = 0; return; }
...
if (apiObj is OrderItemStatus_Pending) { wireObj.tag = 2; return; }
if (apiObj is OrderItemStatus_Done) { wireObj.tag = 3; return; }
            }

void _api_fill_to_wire_order_online_party(OrderOnlineParty apiObj, wire_OrderOnlineParty wireObj) {
                if (apiObj is OrderOnlineParty_Uber) { wireObj.tag = 0; return; }
if (apiObj is OrderOnlineParty_Grab) { wireObj.tag = 1; return; }
if (apiObj is OrderOnlineParty_UberEat) { wireObj.tag = 2; return; }
if (apiObj is OrderOnlineParty_DoorDash) { wireObj.tag = 3; return; }
if (apiObj is OrderOnlineParty_SkipTheDisk) { wireObj.tag = 4; return; }
...
void _api_fill_to_wire_order_type_info(OrderTypeInfo apiObj, wire_OrderTypeInfo wireObj) {
                wireObj.name = api2wire_String(apiObj.name);
...
void _api_fill_to_wire_ticket_status(TicketStatus apiObj, wire_TicketStatus wireObj) {
                if (apiObj is TicketStatus_Cooking) { wireObj.tag = 0; return; }
...
if (apiObj is TicketStatus_Pending) { wireObj.tag = 2; return; }
if (apiObj is TicketStatus_Done) { wireObj.tag = 3; return; }
            }
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_tickets(
    int port_,
    ffi.Pointer<wire_StringList> ticket_ids,
  ) {
    return _wire_get_tickets(
      port_,
      ticket_ids,
    );
  }

  late final _wire_get_ticketsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_StringList>)>>('wire_get_tickets');
  late final _wire_get_tickets = _wire_get_ticketsPtr
      .asFunction<void Function(int, ffi.Pointer<wire_StringList>)>();

  void wire_get_order_items(
    int port_,
    ffi.Pointer<wire_StringList> order_item_ids,
  ) {
    return _wire_get_order_items(
      port_,
      order_item_ids,
    );
  }

  late final _wire_get_order_itemsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_StringList>)>>('wire_get_order_items');
  late final _wire_get_order_items = _wire_get_order_itemsPtr
      .asFunction<void Function(int, ffi.Pointer<wire_StringList>)>();

  void wire_update_order_item(
    int port_,
    ffi.Pointer<wire_OrderItem> order_item,
  ) {
    return _wire_update_order_item(
      port_,
      order_item,
    );
  }

  late final _wire_update_order_itemPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_OrderItem>)>>('wire_update_order_item');
  late final _wire_update_order_item = _wire_update_order_itemPtr
      .asFunction<void Function(int, ffi.Pointer<wire_OrderItem>)>();

  void wire_create_callback_stream(
    int port_,
  ) {
    return _wire_create_callback_stream(
      port_,
    );
  }

  late final _wire_create_callback_streamPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_create_callback_stream');
  late final _wire_create_callback_stream =
      _wire_create_callback_streamPtr.asFunction<void Function(int)>();
  ...
  ffi.Pointer<wire_OrderItem> new_box_autoadd_order_item_0() {
    return _new_box_autoadd_order_item_0();
  }

  late final _new_box_autoadd_order_item_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_OrderItem> Function()>>(
          'new_box_autoadd_order_item_0');
  late final _new_box_autoadd_order_item_0 = _new_box_autoadd_order_item_0Ptr
      .asFunction<ffi.Pointer<wire_OrderItem> Function()>();
